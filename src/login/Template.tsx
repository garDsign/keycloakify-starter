    ...
    return (
        <div className="flex h-screen w-screen overflow-hidden" style={{backgroundColor: 'var(--color-beige-dark)'}}>
            <div className="flex w-full h-full items-stretch justify-center gap-0">
                {/* Left side - Plant illustration (hidden on mobile/tablet) */}
                <div 
                    className="max-lg:hidden flex w-1/2 items-center justify-center relative overflow-hidden rounded-[32px] bg-[var(--color-green-dark)] my-6 ml-6" 
                >
                    {/* Ellipse background */}
                ...
                {/* Right side - Form */}
                <div 
                    className={clsx("flex flex-col items-center relative w-full lg:w-1/2 m-4 lg:my-6 lg:mr-6 lg:ml-0 rounded-[32px] lg:rounded-l-none lg:rounded-r-[32px] bg-[var(--color-beige-dark)]", kcClsx("kcLoginClass"))} 
                >
                    <div className="w-full flex-1 flex items-center justify-center overflow-y-auto px-4 lg:px-0 py-12">
                ...
                <div className="w-full template-input-scope max-w-[440px]">
                    {/* Header */}
                    ...
                    {/* Logo at bottom */}
                    <div className="w-full flex justify-center pb-10 pt-2 px-4">
                        <img src={logoPngUrl} alt="" className="h-6 w-auto object-contain" />
                    </div>
                </div>
